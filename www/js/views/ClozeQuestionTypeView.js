...
ClozeQuestionTypeView.prototype.showAnswer = function (interactive) {
    ...
    if (questionpoolModel.questionList && questionpoolModel.getAnswer()) {
        console.log("entered cloze question answer body");
...
ClozeQuestionTypeView.prototype.showFeedback = function () {
    console.log("enter feedback view in cloze question");
...
function createClozeQuestionBody(domElement, interactive) {
    ...
    if (interactive) {
        console.log("design answer view for cloze question");
        ...
        console.log("design feedback view for cloze question");
        ...
        $("#feedbackBody gap").each(function (i, gap) {
            ...
            console.log("filled gap is " + filledAnswer);
