...
function AuthenticationModel(controller) {
    ...
    self.consumerKey = lmsModel.lmsData.ServerData[servername].consumerKey;
    self.consumerSecret = lmsModel.lmsData.ServerData[servername].consumerSecret;
    self.request_token = null;
    self.request_token_secret = null;
    self.verificationCode_code = null;
...
AuthenticationModel.prototype.setInitParameters = function () {
    ...
    // FIXME we are not using OAuth anynmore
...
AuthenticationModel.prototype.login = function (username, password) {
...
AuthenticationModel.prototype.authenticateUser = function (data) {
