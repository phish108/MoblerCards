 ...
 */
BestDayModel.prototype.calculateValue = function () {
    var self = this;

    self.values = self.superModel.getCurrentValues(SUBMODEL_QUERY_ONE);
    self.queryDB(function cbBDS(t, r) {
        self.calculateBestDayAndScore(t, r);
    });
};
 ...
 * @function queryDB
 */
BestDayModel.prototype.queryDB = queryDatabase;
 ...
 */
BestDayModel.prototype.calculateBestDayAndScore = function (transaction, results) {
